                  ...
                  child: Row(
                    ...
                    children: [
                      Column(
                        children: [
                          Text(
                            all.isEmpty ? '—' : avg.toStringAsFixed(1),
                          ...
                          Text(
                            all.isEmpty
                                ? 'No reviews yet'
                                : 'Based on ${NumberFormat('#,###').format(all.length)} review${all.length == 1 ? '' : 's'}',
...
class _ReviewAvatar extends StatelessWidget {
  const _ReviewAvatar({required this.review, this.radius = 20});
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(_timeAgoLabel(review.createdAt),
                          style: AppTextStyles.caption),
                    ],
                  ),
                ),
      ...
      appBar: AppBar(
        ...
        actions: [
          Padding(
            ...
            child: _ReviewAvatar(review: review, radius: 16),
          ),
        ],
      ),
      body: ListView(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(review.customerName,
                              style: AppTextStyles.bodyBold),
                          Text(
                            '${review.isVerified ? 'VERIFIED PURCHASE • ' : ''}${_timeAgoLabel(review.createdAt).toUpperCase()}',
                            style: AppTextStyles.caption,
                          ),
                        ],
                      ),
