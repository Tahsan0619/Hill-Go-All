...
class SettingsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final avatarUrl = context.watch<AuthProvider>().user?.avatarUrl ?? '';
                ...
                ListTile(
                  ...
                  onTap: () {
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(
                        content: Text(
                          'For support, contact the HillGo team at support@hillgo.com.bd',
                        ),
                      ),
                    );
                  },
                  ...
                  onTap: () {
                    showDialog(
                      ...
                      builder: (_) => AlertDialog(
                        title: const Text('Legal & Privacy'),
                        content: const Text(
                          'By using HillGo Vendor you agree to the HillGo Terms of Service and Privacy Policy. Visit hillgo.com.bd/legal for the full documents.',
                        ),
                        actions: [
                          TextButton(
