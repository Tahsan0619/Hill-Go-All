          ...
          children: [
            Row(
              children: [
                ...
                Expanded(
                  child: Text('#ORD-${order.id.split('-').last}',
            ...
            Row(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                NetworkThumb(url: item.imageUrl, size: 64),
                        ...
                        : () async {
                            final confirm = await showDialog<bool>(
                              ...
                              builder: (_) => AlertDialog(
                                ...
                                content: Text(
                                  'Reject order #${order.id}? This cannot be undone.',
                                ),
                                actions: [
                                  TextButton(
                                    onPressed: () =>
        ...
        Container(
          ...
          child: Row(
            children: [
              ...
              _StatCol(value: '99%', label: 'ON-TIME'),
            ],
          ),
        ),
      ...
      child: AppCard(
        child: Column(
          ...
          children: [
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      const SizedBox(width: 4),
                      Text(
                        (order.rating ?? 5).toStringAsFixed(1),
                        style: AppTextStyles.caption
            ...
            Row(
              children: [
                NetworkThumb(url: item.imageUrl, size: 48),
                const SizedBox(width: 10),
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
