      ...
      return ListView(padding: const EdgeInsets.all(AppSpacing.screenPadding), children: [
        AppCard(color: AppColors.primary, child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Row(crossAxisAlignment: CrossAxisAlignment.end, children: [
            ...
            Padding(padding: const EdgeInsets.only(bottom: 5), child: StatusChip(label: '+${weekly.percentChange.toStringAsFixed(0)}%', fg: AppColors.success, bg: AppColors.successBg)),
          ]),
        ...
        Row(children: [
          ...
          Expanded(child: _stat('Active Hours', '${weekly.activeHours.toStringAsFixed(1)}h', Icons.timer_outlined)),
        ]),
        ...
        TextButton.icon(
          onPressed: () => ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Older earning records will be available soon.'))),
          icon: const Icon(Icons.history),
          label: const Text('View Older Records'),
        ),
    ...
    return AppCard(
      ...
      child: Column(children: [
        ...
        if (expanded) Padding(
          ...
          child: Column(children: [
            _line('Base pay', day.basePay), _line('Tips', day.tips), _line('Surges', day.surges),
          ]),
        ),
      ]),
    );
