...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (!mounted) return;
      context.read<ParcelProvider>().loadDashboard();
    });
  }
          ...
          return ListView(
            ...
            children: [
              AppCard(
                ...
                child: Row(children: [
                  const Icon(Icons.circle, size: 12, color: Color(0xFF7CFF9A)),
                  ...
                  Switch(value: provider.isOnline, activeThumbColor: AppColors.accent, onChanged: provider.setOnline),
                ]),
              ),
              ...
              Stack(children: [
                AppMapView(
                  ...
                  height: 220,
                  markers: [pinMarker(const LatLng(40.7128, -74.0060), color: AppColors.primary, icon: Icons.my_location)],
                ),
                ...
                Positioned(
                  ...
                  child: FloatingActionButton.small(
                    ...
                    onPressed: () {}, child: const Icon(Icons.my_location, color: AppColors.primary),
                  ),
                ),
              ]),
              ...
              AppCard(
                ...
                child: Row(children: [
                  const CircleAvatar(backgroundColor: AppColors.accent, child: Icon(Icons.emoji_events_outlined, color: Colors.white)),
                  const SizedBox(width: 12),
                  Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    Text('Performance Rank', style: AppTextStyles.body.copyWith(color: Colors.white70)),
                    Text(stats.performanceRank, style: AppTextStyles.h2.copyWith(color: Colors.white)),
                  ])),
              ...
              SizedBox(height: 180, child: _trendChart(stats.earningsTrend)),
            ],
          );
        },
      ),
