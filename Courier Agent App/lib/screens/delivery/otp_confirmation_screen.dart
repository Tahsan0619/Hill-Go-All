            ...
            children: [
              ...
              _AlternativeTile(
                ...
                onTap: () {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(
                      content: Text('Package photo capture is ready.'),
                    ),
                  );
                },
              ),
              _AlternativeTile(
                ...
                onTap: () {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(
                      content: Text('Signature confirmation is ready.'),
                    ),
                  );
                },
              ),
              ...
              children: [
                CircleAvatar(
                  ...
                  backgroundImage: NetworkImage(
                    'https://i.pravatar.cc/150?u=${Uri.encodeComponent(parcel.id + personName)}',
                  ),
                ),
