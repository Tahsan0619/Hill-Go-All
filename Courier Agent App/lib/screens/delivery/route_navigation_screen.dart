  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      if (provider.selected?.id != widget.parcelId) {
        await provider.loadParcel(widget.parcelId);
      }
      // Picked-up parcels move to in-transit once navigation begins.
      await provider.startTransitIfNeeded();
    });
  }
          ...
          child: Container(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    'Head to drop-off: ${parcel.receiverAddress}',
                    maxLines: 2,
