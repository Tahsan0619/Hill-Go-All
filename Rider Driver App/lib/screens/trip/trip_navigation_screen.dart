...
class _TripNavigationScreenState extends State<TripNavigationScreen>
  ...
  /// City driving speed for demo auto-move (~32 km/h).
  ...
  Future<void> _startLocationTracking() async {
    try {
      ...
      if (trip != null) {
        ...
        // Far from Dhaka job coords → keep smooth auto-demo.
        if (toJob > 80000) {
          _startSimulation();
          return;
        }
  ...
  Widget build(BuildContext context) {
    ...
    if (_lastStatus != null && _lastStatus != trip.status) {
                              ...
                              children: [
                                ...
                                ListTile(
                                  ...
                                  onTap: () {
                                    ...
                                    ScaffoldMessenger.of(context).showSnackBar(
                                      const SnackBar(
                                        content: Text('Emergency assist contacted (mock)'),
                                      ),
                                    );
                                  },
                                ),
                                ListTile(
                                  ...
                                  onTap: () {
                                    Navigator.pop(context);
                                    ScaffoldMessenger.of(context).showSnackBar(
                                      const SnackBar(content: Text('Trip status shared (mock)')),
                                    );
                                  },
                                ),
                              ],
                    ...
                    child: Row(
                      children: [
                        ...
                        _ActionIcon(
                          ...
                          onTap: () {
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(content: Text('Calling ${trip.customerPhone}')),
                            );
                          },
                        ),
                        const SizedBox(width: 8),
                        _ActionIcon(
                          ...
                          onTap: () {
                            ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(content: Text('Chat opened (mock)')),
                            );
                          },
                        ),
                      ],
